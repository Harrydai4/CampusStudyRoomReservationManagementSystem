...
public class AppService {
    ...
    public Map<String, Object> createReservation(CurrentUser user, Map<String, Object> req) {
        ...
        Integer overlap = jdbc.queryForObject("""
                ...
                where user_id=? and reserve_date=? and status in ('PENDING','USING')
    ...
    public Map<String, Object> myStudyDuration(CurrentUser user, String period) {
        ...
        if ("day".equalsIgnoreCase(normalized)) {
            ...
            int days = "month".equalsIgnoreCase(normalized) ? 30 : 7;
            rows = jdbc.queryForList("""
    ...
    public Map<String, Object> dashboard(CurrentUser admin) {
        ...
        return Map.of("roomCount", roomCount, "pendingUsers", pendingUsers, "todayReservations", todayReservations,
                "usingCount", usingCount, "usage", statisticsUsage(admin), "peak", statisticsPeak(admin));
    }
    ...
    public void auditUser(Long id, boolean approve, String remark) {
    ...
    public void deleteRoom(CurrentUser admin, Long id) {
        ...
        Integer pending = jdbc.queryForObject("select count(*) from reservation where room_id=? and status in ('PENDING','USING')", Integer.class, id);
